...
import com.example.btdanhba_fragment.R
...
class ContactListFragment : Fragment() {
    ...
    val contactsList: List<Contact> = listOf(
        Contact("HAV", "123-456-7890"),
        Contact("NCT", "987-654-3210"),
        Contact("LBV", "555-123-4567"),
        Contact("AAAAAA", "333-888-9999"),
        Contact("EBBBBBBBB", "777-555-1234"),
